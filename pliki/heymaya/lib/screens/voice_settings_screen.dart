    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          // DIAGNOSTYKA GŁOSU - przełącznik UKRYTY PONOWNIE 15.08.2026, po
          // zamknięciu testów androidowych. Historia: ukryty 06.08.2026 jako
          // tryb serwisowy niepotrzebny na co dzień, odkomentowany 14.08.2026 na
          // czas uruchamiania Androida (bez niego zgłoszenie „komendy nie
          // działają" jest nie do rozstrzygnięcia z ekranu: odrzucona fraza jest
          // z założenia CICHA - patrz _opisFrazy w voice_vosk_screen - więc
          // „nie usłyszałam" i „usłyszałam, ale odrzuciłam" wyglądają
          // identycznie). Głos na Androidzie działa, więc wraca pod komentarz.
          //
          ...
          //
          // POZYCJA UKRYTA 15.08.2026 - testy androidowe zamknięte, a to
          // narzędzie serwisowe, nie ustawienie: pokazuje techniczny opis
          // kanału („ok: ton TONE_PROP_PROMPT na media", nazwy strumieni, treść
          // wyjątku), czyli coś, czego pszczelarz nie ma jak zinterpretować.
          //
          ...
          // systemu. Tak wybrano ton potwierdzenia (runda 5). Sam mechanizm
          // ([SoundHelper.beep] i [SoundHelper.ostatniSygnal]) ZOSTAJE
          // nietknięty, więc przy zmianie tonu albo kolejnej diagnozie
