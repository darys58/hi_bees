...
// usunięte mateczniki                                
                                      ToggleButtons(                                     
                                        direction: Axis.horizontal, 
                                        onPressed: (int index) {
                                          _showAlertNr(AppLocalizations.of(context)!.nUmberOfCellsRemoved, 12); //klawiatura 0..10 z gridItemsMateczniki - patrz _showAlertNr
                                        },
                                        borderRadius: const BorderRadius.all(Radius.circular(8)),
                                        borderColor: Color.fromARGB(255, 162, 103, 0),
                                        selectedBorderColor: Color.fromARGB(255, 162, 103, 0), //obramowanie wybranego przycisku
...
//mateczniki                                
                                      ToggleButtons(                                     
                                        direction: Axis.horizontal, 
                                        onPressed: (int index) {
                                          _showAlertNr(AppLocalizations.of(context)!.nUmberOfQueenCells, 11); //klawiatura 0..10 z gridItemsMateczniki - patrz _showAlertNr
                                        },
                                        borderRadius: const BorderRadius.all(Radius.circular(8)),
                                        borderColor: Color.fromARGB(255, 162, 103, 0),
                                        selectedBorderColor: Color.fromARGB(255, 162, 103, 0), //obramowanie wybranego przycisku
