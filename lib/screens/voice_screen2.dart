...
class VoiceScreen2 extends StatefulWidget {
  static const routeName = '/screen-voice2'; //nazwa trasy do tego ekranu
...
//String  test = "0";
 ...
 //sprawdzenie czy jest internet
  ...
  void wakeWordCallback() {
    if (!mounted) return; //widget nie istnieje - ignoruj callback

    //anulowanie timera z poprzedniej komendy - nowe wybudzenie resetuje cykl
...
//Mark + Number
  ...
  Future<void> _stopProcessing() async {
    ...
    _inferenceTimer?.cancel(); //anulowanie timera przy zatrzymaniu
