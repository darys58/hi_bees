...
//final wersja = ['1','0','0','2','22.05.2020','nic']; //major, minor - wersja(zmiana w bazie), kolejna wersja bo wymaga tego iOS, numer wydania
  ...
  //1.12.0 95 03.08.2026 - nowe sterowanie głosem z modelem Vosk-PL, Picovoice usunięty, notatki do przeglądów i do Notatnika wprowadzane głosem + nagrywany dźwięk, słowne cofanie (do 5 razy) zapisów "hej maja cofnij ostatni zapis", komenda głosowa "ustaw ule od X do Y" (zapis dla zakresu uli), naprawa znikającego typu ula w belce (typ nie był zachowywany przy imporcie z chmury)
