...
class NotePriorytetItem extends StatefulWidget {
  @override
  State<NotePriorytetItem> createState() => _NotePriorytetItemState();
}

class _NotePriorytetItemState extends State<NotePriorytetItem> {
            ...
            child: ListTile(
              ...
              title: globals.isEuropeanFormat()
                ...
                : Text("${notatki.data.substring(5, 7)}-${notatki.data.substring(8)}  ${notatki.tytul}", 
                  style: const TextStyle(fontSize: 16,
                  fontWeight: FontWeight.bold)),
              //nagranie podyktowanej notatki - patrz RecordingHelper
              subtitle: Column(
